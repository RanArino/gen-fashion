...
- [ ] Milestone B — Data plane: Compute Engine Elasticsearch node (`pd-balanced` + static internal IP), Cloud Run **Direct VPC egress** private connectivity verification (no Serverless VPC Access connector — ADL-023, re-scoped 2026-06-27 for cost), full vector seed (MD-3, MD-4, MD-10).
