...
- [x] (2026-07-06) Removed the legacy default Hosting origin `https://animation-agent.web.app/*` from the live and documented browser-key referrer allowlist; current allowed referrers are `https://gen-fashion-app.web.app/*`, `https://animation-agent.firebaseapp.com/*`, and localhost development.
