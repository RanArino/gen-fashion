...
- [x] (2026-06-30 15:18Z) Restricted the live Firebase browser key to `https://gen-fashion-app.web.app/*`, `https://your-project-id.web.app/*`, and `http://localhost:8088/*`.
- [x] (2026-07-06) Removed the legacy default Hosting origin `https://your-project-id.web.app/*` from the live and documented browser-key referrer allowlist; current allowed referrers are `https://gen-fashion-app.web.app/*`, `https://your-project-id.firebaseapp.com/*`, and localhost development.
